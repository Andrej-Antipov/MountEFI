...
if [[ $loc = "ru" ]]; then
    case $1 in
    0)  bbuf[0]=$(printf '\033[2;0f'${cm[head_ast]}'*********           '${cm[head_str]}'Программа монтирует EFI разделы в Mac OS ('${cm[head_X]}'X'${cm[head_str]}'.'${cm[head_os]}'11 '${cm[head_str]}'- '${cm[head_X]}'XI'${cm[head_str]}'.'${cm[head_os]}'01'${cm[head_str]}')          '${cm[head_ast]}'*********'${cm[clr]}'')
    ...
    6)  bbuf[6]=$(printf '\033[14;0f    '${cm[dots_line3]}...................................................................................${cm[clr]}'     ')
       ...
       case $1 in
    0)  bbuf[0]=$(printf '\033[2;0f'${cm[head_ast]}'*********         '${cm[head_str]}'This program mounts EFI partitions on Mac OS ('${cm[head_X]}'X'${cm[head_str]}'.'${cm[head_os]}'11 '${cm[head_str]}'- '${cm[head_X]}'XI'${cm[head_str]}'.'${cm[head_os]}'01'${cm[head_str]}')        '${cm[head_ast]}'*********'${cm[clr]}'')
